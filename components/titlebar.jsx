...
import { showModal } from "./modals.jsx";
...
export const Titlebar = () => {
    return <div class="AppHeader AppHeader-titlebar">
        <div id="AppHeader-colors-button">
            <a class="Button Button--iconOnly Button--secondary Button--medium AppHeader-button color-fg-muted" onClick={() => {
                fetch("https://raw.githubusercontent.com/DaBluLite/DiscordColorways/master/index.json")
                .then(res => res.json())
                .then(data => {
                    const colors = data.colorways || fallbackColorways;
